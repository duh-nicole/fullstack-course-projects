...
if ($product_id != FALSE && $category_id != FALSE) {
    ...
    $queryProduct = 'SELECT productCode, productName, listPrice, description, categoryID, productID
                    FROM products
    ...
    $queryAllCategories = 'SELECT categoryID, categoryName
                            FROM categories
                            ORDER BY categoryID';
                ...
                <tr>
                  ...
                  <td>Code:</td>
                    ...
                    <td><input type="text" name="code"
                        value="<?php echo $product['productCode']; ?>"><br></td>
                </tr>
                <tr>
